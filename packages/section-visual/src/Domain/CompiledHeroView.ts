...
/**
 * Compiled filter with all parameters resolved to numbers.
 * Used for color adjustment via 1D LUT.
 */
...
export function isCompiledFilterProcessor(
  config: CompiledProcessorConfig
): config is CompiledFilterProcessor {
