...
/**
 * Filter processor configuration (used in ProcessorNodeConfig.modifiers)
 *
 * Applies color adjustments via 1D LUT (exposure, brightness, contrast, etc.)
 * Supports timeline animation through PropertyValue system.
 */
